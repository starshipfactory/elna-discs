...
if (!defined($outfile) || $help) {
	...
	print(STDERR "output.scad    Output file. The output is a module and needs to be included into another OpenSCAD file to be useful.\n");
	print(STDERR "               See elna-wellen.scad for an example. Default: disc.scad\n");
	print(STDERR "steps          Number of interpolated steps per edge. Default: 24\n");
	print(STDERR "interpolate    Interpolate between control points instead of applying the wave function continuously.\n");
	print(STDERR "               Ignored when control points are given, as they are always interpolated.\n");
	print(STDERR "function       Function to be evaluated over the range of 0 to 1. The result should be between 0 and 1.\n");
	print(STDERR "               The function will be evaluated using Perl eval(), \$_ holds the input value\n");
	print(STDERR "radiusN        List of control points (usually between 0 and 1)\n");
	print(STDERR "Examples:      elna.pl 1 0.9 1 0.9 1 0.9 1 0.9 1 0.9 1 0.9 1 0.9 1 0.9 1 0.9\n");
	print(STDERR "               elna.pl 1 1 1 0.9 0.9 0.9 1 1 1 0.9 0.9 0.9 1 1 1 0.9 0.9 0.9\n");
	print(STDERR "               elna.pl --function 'sin(\$_*2*3.141592654*12)*0.05+0.95'\n");
	exit(1);
}
